...
export const prismaPackagePath = path.normalize(`${__dirname}/../../files/nestjs/package-prisma`)
export const prismaSchemaPath = path.normalize(`${__dirname}/../../files/nestjs/schema.prisma`)
